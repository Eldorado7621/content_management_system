...
<!-- Modal -->
<div class="modal fade" id="b{{$meeting->id}}" tabindex="-1" role="dialog" aria-labelledby="{{$meeting->id}}" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      @method('delete')
       ...
       <label class="form-control-label" for="input-email">Are you sure that you want to delete this?</label> <br>
        ...
        <input type="hidden" value="{{$meeting->id}}" name="meeting"/>
