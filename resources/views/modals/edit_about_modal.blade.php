  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input class="form-control" type="text" placeholder="" value="{{$about->title}}" name="title">
        <label class="form-control-label" for="input-title">Message</label> <br>
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="message">{{$about->message}}</textarea>
